# Pravrudhi — evolution log

| Date | Card | Status | Delta | Deviations |
|---|---|---|---|---|
| 2026-09-04 | L0 | pass (signoff pending) | scaffold, schema, hooks, gate tooling, paper skeleton | 2 |
...
| 2026-09-05 | L5 | pass (signoff pending) | init/status/export/serve, API with human-only sign-off, plugin skills, README quickstart, headline check | 3 |
