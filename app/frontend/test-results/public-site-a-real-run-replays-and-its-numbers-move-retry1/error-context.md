...
- Name: public-site.spec.ts >> a real run replays, and its numbers move
- Location: e2e/public-site.spec.ts:24:5
...
Locator: getByText(/A real run, replayed/i)
Expected: visible
Timeout: 15000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText(/A real run, replayed/i) with timeout 15000ms
  - waiting for getByText(/A real run, replayed/i)
